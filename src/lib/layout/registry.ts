  ...
  "sidebar-left": {
    ...
    slots: [
      ...
      },
      {
        ...
        required: false,
        maxSections: 4,
        accepts: ["bio", "skills", "interests", "social", "stats", "contact"],
        order: 2,
        mobileOrder: 2,
      },
      {
  ...
  "bento-standard": {
    ...
    slots: [
      ...
      },
      {
        ...
        required: false,
        maxSections: 1,
        accepts: ["skills", "interests", "stats", "achievements"],
        order: 2,
        mobileOrder: 3,
      },
      {
      ...
      },
      {
        ...
        required: false,
        maxSections: 1,
        accepts: ["skills", "interests", "social", "stats", "contact"],
        order: 4,
        mobileOrder: 4,
      },
      {
