...
const L10N: Record<string, L10nStrings> = {
  ...
  it: {
    ...
    passionateAbout: (items) => `Entusiasta di ${items}.`,
  ...
  es: {
    ...
    passionateAbout: (items) => `Entusiasta de ${items}.`,
  ...
  pt: {
    ...
    passionateAbout: (items) => `Com paixão por ${items}.`,
