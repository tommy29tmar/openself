    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        <button
          ...
          disabled={uploading}
          className="px-3 py-1.5 text-xs font-medium rounded border border-[var(--page-border,#e5e5e5)] text-[var(--page-fg,#ccc)] hover:bg-[var(--page-bg-secondary,#f5f5f5)] transition-colors disabled:opacity-40"
        >
        ...
        {avatarUrl && (
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium rounded border border-[var(--page-border,#e5e5e5)] text-[var(--page-fg,#ccc)] hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors"
          >
            Remove
          </button>
        )}
