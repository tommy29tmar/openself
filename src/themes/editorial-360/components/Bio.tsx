        ...
        return (
            <section className="theme-reveal">
                ...
                <div className="max-w-2xl">
                    <span className="text-4xl text-[var(--page-fg-secondary)] opacity-30 leading-none select-none" aria-hidden="true">{"\u201C"}</span>
                    <p className="text-xl font-light leading-loose text-[var(--page-fg-secondary)] -mt-4 ml-4">
                        {text}
                    </p>
                    <span className="text-4xl text-[var(--page-fg-secondary)] opacity-30 leading-none select-none block text-right -mt-2" aria-hidden="true">{"\u201D"}</span>
                </div>
            </section>
        );
    }
