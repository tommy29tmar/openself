 ...
 *
 * Credentials:
 *   Email:    sara.benedetti@openself.dev
 *   Password: UatDemo2026!
 *   Username: sara
 */
...
const EMAIL = "sara.benedetti@openself.dev";
const PASSWORD = "UatDemo2026!";
const DISPLAY_NAME = "Sara Benedetti";
const USERNAME = "sara";
...
async function main() {
  ...
  const allFacts = [
    ...
    makeFact(sessionId, profile.id, "project", "project-localfirst-crdt", {
      ...
      url: "https://github.com/sara/local-first-crdt",
    ...
    makeFact(sessionId, profile.id, "project", "project-devlog", {
      ...
      url: "https://github.com/sara/devlog",
    ...
    makeFact(sessionId, profile.id, "project", "project-dotfiles", {
      ...
      url: "https://github.com/sara/dotfiles",
    ...
    makeFact(sessionId, profile.id, "social", "linkedin", {
      platform: "LinkedIn",
      url: "https://linkedin.com/in/sarabenedetti",
      label: "sarabenedetti",
    }),
    makeFact(sessionId, profile.id, "social", "twitter", {
      platform: "Twitter",
      url: "https://twitter.com/saracodes",
      label: "@saracodes",
    }),
    ...
    makeFact(sessionId, profile.id, "social", "mastodon", {
      platform: "Mastodon",
      url: "https://fosstodon.org/@sara",
      label: "@sara@fosstodon.org",
    }),
    ...
    makeFact(sessionId, profile.id, "contact", "email", {
      type: "email",
      value: "sara.benedetti@openself.dev",
      label: "Email",
    }),
  ];
  ...
  const memories: Array<{ content: string; type: "observation" | "preference" | "insight" | "pattern"; category?: string }> = [
    {
      content: "Sara prefers minimal, clean designs. He specifically asked for the 'editorial-360' theme but later switched to 'minimal' because he values whitespace and readability above all.",
      type: "preference",
      category: "design",
    },
    {
      content: "When discussing his work history, Sara emphasizes impact over titles. He's prouder of the design system migration at Zalando (used by 30+ teams) than his Senior title.",
      type: "observation",
      category: "career",
    },
    {
      content: "Sara is Italian but lives in Berlin. He switches to Italian expressions when excited or frustrated. His page should feel international but with subtle Italian warmth.",
      type: "insight",
    ...
    {
      content: "Sara strongly prefers local-first architecture. He's skeptical of cloud-only solutions and gets animated when discussing data sovereignty. This is a core value, not just a technical preference.",
      type: "insight",
      category: "values",
    },
    {
    ...
    {
      content: "When reviewing his page, Sara consistently asks for shorter sentences. He follows the principle: 'If you can say it in fewer words, do it.'",
      type: "pattern",
      category: "writing",
    },
    {
      content: "Sara's communication style in conversations follows a pattern: starts with a high-level question, dives into specifics, then steps back to verify the big picture. He appreciates when the agent mirrors this structure.",
      type: "pattern",
  ...
  console.log("   Published: http://localhost:3000/sara");
